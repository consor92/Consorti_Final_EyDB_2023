...
int listaDesplegable(lista_Desplegable registro[],int dato,int r)
{
    ...
    do
    {
        ...
        gotoxy(5,5);
        recuadro(2,largo);
        mostrarRegistro(registro,r,0,6);
        ...
        while (true) {
            ...
            if (opcionSeleccionada >= 1 && opcionSeleccionada <= r) {
                ...
                return opcion-1; // Sale de la función si la opción es válida
            }
        }
...
void leyendaRegistro(int dato)
{
    ...
    switch (dato)
    {
        case 1: Color(WHITE,RED);
                printf("SELECCIONE EL TALONARIO                                      \n");
                Color(BLACK,WHITE);
                break;
        case 2: Color(WHITE,RED);
                printf("INGRESE LOS ITEMS A FACTURAR                                 \n");
                Color(BLACK,WHITE);
                break;
        case 3: Color(WHITE,RED);
                printf("SELECCIONE LA FACTURA PARA ANULAR                            \n");
                Color(BLACK,WHITE);
                break;
        case 4: Color(WHITE,RED);
                printf("SELECCIONE EL CLIENTE A MODIFICAR                            \n");
                Color(BLACK,WHITE);
                break;
    }
    linea(Largo);
